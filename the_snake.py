...
class Snake(GameObject):
    ...
    def move(self, is_increased):
        ...
        Параметры:
            is_increased (bool): Указывает, увеличилась ли длина змеи после последнего шага.
        """
    ...
    def draw(self):
        """Отрисовка тела змеи, включая голову и затирание последнего сегмента."""
...
def main():
    ...
    Создает игровой цикл, в котором обрабатываются действия пользователя, обновляются позиции змеи и яблока,
    выполняется отрисовка и проверяются условия конца игры.
    """
    pygame.init()
    snake = Snake()
    apple = Apple()
